...
public class BodyPartFragment extends Fragment {
    ...
    private final String mList="mImages";
    private final String mIndex="mIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(savedInstanceState!=null)
        {
            ...
            mImageIds=savedInstanceState.getIntegerArrayList(mList);
            mListIndex=savedInstanceState.getInt(mIndex);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(mList, (ArrayList<Integer>) mImageIds);
        outState.putInt(mIndex,mListIndex);
