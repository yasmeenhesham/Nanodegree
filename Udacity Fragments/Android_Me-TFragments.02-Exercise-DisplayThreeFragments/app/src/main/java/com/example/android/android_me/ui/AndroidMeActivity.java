...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Integer> Images= AndroidImageAssets.getHeads();
        List<Integer> bodyImg= AndroidImageAssets.getBodies();
        List<Integer> legImg=AndroidImageAssets.getLegs();
        // TODO (4) Set the list of image id's for the head fragment and set the position to the second image in the list
        headFragment.setmImages(Images);
