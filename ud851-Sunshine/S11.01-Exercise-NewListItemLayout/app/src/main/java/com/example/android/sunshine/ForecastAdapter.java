...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.highTmpView.setText(highString);

         /* Set the text and content description (for accessibility purposes) */
        //forecastAdapterViewHolder.descView.setContentDescription(descriptionA11y);
        ...
        String lowA11y = mContext.getString(R.string.a11y_low_temp, lowString);
         ...
         /* Set the text and content description (for accessibility purposes) */
        //forecastAdapterViewHolder.lowTmpView.setContentDescription(lowA11y);
        forecastAdapterViewHolder.weatherIcon.setImageResource(weatherImageId);
        forecastAdapterViewHolder.dateView.setText(dateString);
        forecastAdapterViewHolder.lowTmpView.setText(lowString);
        forecastAdapterViewHolder.descView.setText(description);
...
//      TODO (4) Replace the weatherSummary TextView with individual weather detail TextViews
        ...
        final TextView highTmpView;
        final TextView lowTmpView;
...
//          TODO (6) Get references to all new views and delete this line
            ...
            descView = (TextView) view.findViewById(R.id.weatherDiscription);
            highTmpView = (TextView) view.findViewById(R.id.high_temperature);
            lowTmpView = (TextView) view.findViewById(R.id.low_temperature);
            weatherIcon =(ImageView) view.findViewById(R.id.weaterIcon);
