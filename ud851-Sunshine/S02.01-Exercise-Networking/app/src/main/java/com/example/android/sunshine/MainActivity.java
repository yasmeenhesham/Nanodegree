...
//        }
    ...
    private void loadWeatherData()
    {
        ...
        new NetAsync().execute(location);
    }
    // TODO (5) Create a class that extends AsyncTask to perform network requests
    public class NetAsync extends AsyncTask<String,Void,String[]>
    {
        @Override
        protected String[] doInBackground(String... strings) {
            ...
            try {
                ...
                String S =NetworkUtils.getResponseFromHttpUrl(weatherUrl);
                String[] simpleweather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,S);
