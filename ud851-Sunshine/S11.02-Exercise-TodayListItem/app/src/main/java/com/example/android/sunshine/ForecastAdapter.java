...
//  TODO (6) Declare constant IDs for the ViewType for today and for a future day
    ...
    private static final int ID_FOR_TODAYVIEW=0;
    private static final int ID_FOR_FUTUREVIEW=1;
...
//      TODO (8) Set mUseTodayLayout to the value specified in resources
    ...
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType)
        {
            case ID_FOR_TODAYVIEW: {
                layoutID = R.layout.list_item_forecast_today;
                break;
            }
            case ID_FOR_FUTUREVIEW: {
                layoutID = R.layout.forecast_list_item;
                break;
            }
                default:
                    throw new IllegalArgumentException("INVALID VIEW "+ viewType);
        }
...
//      TODO (17) Otherwise, throw an IllegalArgumentException
            default:
                throw new IllegalArgumentException("invlid ID "+viewType);
        }
...
//      TODO (11) Otherwise, return the ID for future day viewType
    ...
    public int getItemViewType(int position) {
        if (mUseTodayLayout && position == 0)
            return ID_FOR_TODAYVIEW;
        else
            return ID_FOR_FUTUREVIEW;
    }
