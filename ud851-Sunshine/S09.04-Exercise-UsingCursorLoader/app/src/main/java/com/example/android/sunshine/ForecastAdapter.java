...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    //  TODO (14) Remove the mWeatherData declaration and the setWeatherData metho
...
//      TODO (8) Display the summary that you created above
        long dateInMillie= mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String date= SunshineDateUtils.getFriendlyDateString(mContext,dateInMillie,false);
        int weatherid=mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        String description= SunshineWeatherUtils.getStringForWeatherCondition(mContext,weatherid);
        double high_temp=mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
        double low_temp=mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
        String highLow=SunshineWeatherUtils.formatHighLows(mContext,high_temp,low_temp);
        String weatherSummary = date + " - " + description + " - " + highLow;
