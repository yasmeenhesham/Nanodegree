...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryInfo.weatherIcon.setImageResource(weatherIcon);
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraDetails.humiditymessure.setText(humidityString);
        mDetailBinding.extraDetails.humiditymessure.setContentDescription(humidityally);
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        mDetailBinding.extraDetails.windmessure.setText(windString);
        mDetailBinding.extraDetails.windmessure.setContentDescription(windally);
        mDetailBinding.extraDetails.windLable.setContentDescription(windally);
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        mDetailBinding.extraDetails.pressuremessure.setText(pressureString);
        mDetailBinding.extraDetails.pressuremessure.setContentDescription(pressureally);
        mDetailBinding.extraDetails.pressureLable.setContentDescription(pressureally);
