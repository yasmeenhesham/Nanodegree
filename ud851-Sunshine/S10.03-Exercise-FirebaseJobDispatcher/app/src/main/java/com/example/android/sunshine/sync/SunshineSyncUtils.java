...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_HOURS=3;
    private static final int SYNC_SECONDS=(int) TimeUnit.HOURS.toSeconds(SYNC_HOURS);
    private static final int SYNC_FLEXTIME_SECONDS = SYNC_SECONDS / 3;
    private static boolean sInitialized;

//  TODO (11) Add a sync tag to identify our sync job
    private static final String SYNC_TAG ="jopdispatcher_data";
    ...
    static void scheduleFirebaseJobDispatcherSync(final Context context)
    {
        ...
        Job job=firebaseJobDispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        SYNC_SECONDS,
                        SYNC_SECONDS + SYNC_FLEXTIME_SECONDS))
