...
//          TODO (3) Create an Intent with the proper URI to start the DetailActivity
            Intent detalIntent=new Intent(context, DetailActivity.class);
            detalIntent.setData(todaysWeatherUri);
//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder=TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(detalIntent);
