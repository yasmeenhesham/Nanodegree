...
class Emojifier {
    ...
    public static void getClassifications(Face face)
    {
        ...
        Log.d(LOG_TAG ,"getClassifications: LeftEyeBeingOpen = " +face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG ,"getClassifications: RightEyeBeingOpen = " +face.getIsRightEyeOpenProbability());
