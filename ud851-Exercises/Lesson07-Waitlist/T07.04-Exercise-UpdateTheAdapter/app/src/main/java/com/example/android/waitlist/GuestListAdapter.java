...
public class GuestListAdapter extends RecyclerView.Adapter<GuestListAdapter.GuestViewHolder> {
    ...
    public GuestListAdapter(Context context, Cursor data) {
    ...
    public void onBindViewHolder(GuestViewHolder holder, int position) {
        ...
        String mGestName=mCursor.getString(mCursor.getColumnIndex(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME));
        int mGestSize=mCursor.getInt(mCursor.getColumnIndex(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE));
        holder.nameTextView.setText(mGestName);
        holder.partySizeTextView.setText(String.valueOf(mGestSize));
