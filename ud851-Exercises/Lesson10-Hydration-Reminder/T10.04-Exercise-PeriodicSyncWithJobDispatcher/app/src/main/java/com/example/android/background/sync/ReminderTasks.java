...
public class ReminderTasks {
    ...
    public static final  String ACTION_CHARGER_REMINDER= "chrger_reminder";
    ...
    public static void executeTask(Context context, String action) {
        ...
        {
            incrementchargerreminder(context);
        }
    }

    private static void incrementchargerreminder(Context context) {
