...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
       ...
       // new GithubQueryTask().execute(githubSearchUrl);
        ...
        LoaderManager mLoderManager=getSupportLoaderManager();
        mLoderManager.getLoader(GITHUB_SEARCH_LOADER);
        if(mLoderManager==null)
        {
            mLoderManager.initLoader(GITHUB_SEARCH_LOADER,queryBundle,this);
        }
        else
        {
            mLoderManager.restartLoader(GITHUB_SEARCH_LOADER,queryBundle,this);
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String murl=args.getString(SEARCH_QUERY_URL_EXTRA);
                if(murl==null||murl.isEmpty())
                return null;
                try {
                    URL searchUrl=new URL(murl);
