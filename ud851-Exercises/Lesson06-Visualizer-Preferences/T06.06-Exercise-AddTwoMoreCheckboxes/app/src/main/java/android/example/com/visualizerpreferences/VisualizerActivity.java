...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_middle_key),
                getResources().getBoolean(R.bool.pref_show_middle_default)));
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(R.string.pref_show_trible_key),
                getResources().getBoolean(R.bool.pref_show_trible_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        else if(key.equals(getString(R.string.pref_show_middle_key)))
        {
            mVisualizerView.setShowMid(sharedPreferences.getBoolean(key,
                    getResources().getBoolean(R.bool.pref_show_middle_default)));
        }
        else if(key.equals(getString(R.string.pref_show_trible_key)))
        {
