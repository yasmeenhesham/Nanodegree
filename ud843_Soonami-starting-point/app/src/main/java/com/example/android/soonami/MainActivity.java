...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2012-01-01&endtime=2012-12-01&minmagnitude=7";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e(LOG_TAG,"URL EXECPTION IN TsunamiAsyncTask");
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if(urlConnection.getResponseCode()==200) {
                    ...
                    Log.e(LOG_TAG,"Not equal 200");

                }

            } catch (IOException e) {
                Log.e(LOG_TAG,"URL EXECPTION IN makeHttpRequest");
